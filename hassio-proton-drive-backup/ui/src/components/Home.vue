      ...
      <v-row class="align-start justify-center">
        ...
        <v-col cols="auto" md="7" class="pt-4">
          <v-row class="justify-center justify-md-start">
            <v-col cols="11" md="6" v-for="(backup, i) in store.backups" :key="backup.id">
          ...
          <v-row v-if="store.pinnedBackups.length > 0" class="justify-center justify-md-start">
            <v-col cols="11" class="pb-0">
              <div class="d-flex flex-column align-center align-md-start">
                <h2>Pinned Backups</h2>
              </div>
            </v-col>
            <v-col cols="11" md="6" v-for="(backup, i) in store.pinnedBackups" key="backup.id">
              <div class="d-flex flex-column align-center">
                <BackupCard :backup=backup></BackupCard>
              </div>
            </v-col>
