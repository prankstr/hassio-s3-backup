		...
		<v-card-text>
			<v-row class="pt-0">
				...
				<v-col class="pr-0 pt-0">
					<div class="text-white text-subtitle-1">{{ bs.driveBackupsCount }} / {{ cs.config.backupsOnDrive }} ({{ bs.driveBackupsSize }})</div>
				</v-col>
			</v-row>
			<v-row class="pt-0">
				<v-col cols="5" class="pr-0 pt-0">
				...
				<v-col class="pr-0 pt-0">
					<div class="text-white text-subtitle-1">{{ bs.haBackupsCount }} / {{ cs.config.backupsInHA }} ({{ bs.haBackupsSize }})</div>
				</v-col>
			</v-row>
			<v-row class="pt-0">
				<v-col cols="5" class="pr-0 pt-0">
